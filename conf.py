...
BLOG_AUTHOR = "Brandon W Maister"  # (translatable)
BLOG_TITLE = "Light Fiction"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://quodlibetor.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://quodlibetor.github.io/"
BLOG_EMAIL = "quodlibetor@gmail.com"
BLOG_DESCRIPTION = "ain't that the truth"  # (translatable)
